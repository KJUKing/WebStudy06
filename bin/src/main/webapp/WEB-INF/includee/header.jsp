    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
		...
		<li class="nav-item">
			...
			<a class="nav-link nav-icon" href="${pageContext.request.contextPath }?lang=en">영문</a>
		</li>
		<li class="nav-item">
			<a class="nav-link nav-icon" href="${pageContext.request.contextPath }?lang=ko">한글</a>
		</li>
        <li class="nav-item dropdown">
		...
		<security:authorize access="isAnonymous()">
			<li class="nav-item">
              <a class="nav-link nav-icon" href="${pageContext.request.contextPath }/login">
		...
		<security:authorize access="isAuthenticated()">
	        ...
	        <li class="nav-item dropdown pe-3">
	          ...
	          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
	            ...
	            <span class="d-none d-md-block dropdown-toggle ps-2">${principal.username}</span>
	          </a><!-- End Profile Iamge Icon -->
	
	          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
	            <li class="dropdown-header">
	              <h6>IP</h6>
	              <span>${details.remoteAddress }</span>
	            </li>
	            <li>
	              <hr class="dropdown-divider">
	            </li>
